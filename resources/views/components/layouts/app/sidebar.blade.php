        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group :heading="__('Workspaces')" class="grid">
                    <flux:navlist.item icon="folder" :href="route('workspaces')" :current="request()->routeIs('workspaces')" wire:navigate>{{ __('My Workspaces') }}</flux:navlist.item>
                    <flux:navlist.item icon="plus" :href="route('create-workspace')" :current="request()->routeIs('create-workspace')" wire:navigate>{{ __('Create Workspace') }}</flux:navlist.item>
                </flux:navlist.group>
